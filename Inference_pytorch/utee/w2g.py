...
class w2g(nn.Module):
    ...
    def __init__(self, delta_g, Gmin, G_SA0, G_SA1, weight_shape,
        ...
        self.SAF_pos = SAF.SAF(weight_shape, p_SA0=self.p_SA0, p_SA1=self.p_SA1,
                           G_SA0=self.G_SA0, G_SA1=self.G_SA1)
        self.SAF_neg = SAF.SAF(weight_shape, p_SA0=self.p_SA0, p_SA1=self.p_SA1,
                           G_SA0=self.G_SA0, G_SA1=self.G_SA1)
